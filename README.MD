...
- Basics
  - [LLM applications](https://python.langchain.com/docs/tutorials/llm_chain/): Build and deploy a simple LLM application.  [source code](basics/1_chat-models-and-prompt_templates.ipynb)
